...
<body class="page-header-fixed">
			...
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown user">
					...
					<ul class="dropdown-menu">
						...
						<li>
							<a href="#"><i class="fa fa-dollar"></i>Your Points:{{ Auth::user()->poin }}</a>
						</li>
						<li class="divider">
						</li>
						<li>
	...
	<div class="footer">
		<div class="footer-inner">
			2024 &copy; Conquer by Nico Victorio.
		</div>
	...
	<script src="{{ asset('conquer/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.js') }}" type="text/javascript">
	</script>
	...
	<script src="{{ asset('conquer/plugins/bootstrap-daterangepicker/moment.min.js') }}" type="text/javascript">
	</script>
	...
	<script>
		document.addEventListener('DOMContentLoaded', function() {
			// Ambil semua elemen sidebar yang memiliki tag <li> dalam sidebar
			const sidebarItems = document.querySelectorAll('.page-sidebar-menu li');
	
			// Tambahkan event listener untuk setiap elemen sidebar
			sidebarItems.forEach(item => {
				const link = item.querySelector('a'); // Ambil elemen <a> di dalam <li>
				if (link) {
					link.addEventListener('click', function() {
						...
						// Tambahkan kelas "active" ke elemen sidebar yang diklik
